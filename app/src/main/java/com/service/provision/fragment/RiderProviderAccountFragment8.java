...
public class RiderProviderAccountFragment8 extends MultiPickerWrapperSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        insurance_sticker_image.setOnClickListener(view -> {
            if (insurance_sticker_image.getDrawable() == null) {
                ...
                idPicBitmap = ((RoundedDrawable) insurance_sticker_image.getDrawable()).getSourceBitmap();
    ...
    public void init() {
        if (realmProvider != null) {
            String picture = realmProvider.getInsurance_sticker_image_url();
            boolean pictureExists = picture != null;
            if (pictureExists) {
                Glide.with(getContext())
                        .load(realmProvider.getInsurance_sticker_image_url())
