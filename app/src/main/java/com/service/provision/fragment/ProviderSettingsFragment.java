...
public class ProviderSettingsFragment extends Fragment {
    ...
    CardView attendancebtn, homeworkbtn, paymentsbtn, website, profilebtn, displaybtn, availabilitybtn, permission, apppermission, logout, groups, faqs, webportal, resetpassword, conferencecallno, backup, restore, addvirtualaccount, change_number, walletbtn;
