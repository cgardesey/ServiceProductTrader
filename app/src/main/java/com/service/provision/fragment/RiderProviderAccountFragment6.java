...
public class RiderProviderAccountFragment6 extends MultiPickerWrapperSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        drivers_licence_image.setOnClickListener(view -> {
            if (drivers_licence_image.getDrawable() == null) {
                ...
                idPicBitmap = ((RoundedDrawable) drivers_licence_image.getDrawable()).getSourceBitmap();
    ...
    public void init() {
        if (realmProvider != null) {
            String picture = realmProvider.getDrivers_licence_reverse_image_url();
            boolean pictureExists = picture != null;
            if (pictureExists) {
                Glide.with(getContext())
                        .load(realmProvider.getDrivers_licence_reverse_image_url())
