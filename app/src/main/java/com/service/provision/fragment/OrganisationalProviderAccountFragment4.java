...
public class OrganisationalProviderAccountFragment4 extends MultiPickerWrapperSupportFragment {
    ...
    private static final String TAG = "OrganisationalProviderAccountFragment4";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View rootView = inflater.inflate(R.layout.fragment_organisational_provider_account4, container, false);
