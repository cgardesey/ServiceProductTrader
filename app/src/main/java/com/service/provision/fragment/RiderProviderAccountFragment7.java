...
public class RiderProviderAccountFragment7 extends MultiPickerWrapperSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        road_worthy_sticker_image.setOnClickListener(view -> {
            if (road_worthy_sticker_image.getDrawable() == null) {
                ...
                idPicBitmap = ((RoundedDrawable) road_worthy_sticker_image.getDrawable()).getSourceBitmap();
    ...
    public void init() {
        if (realmProvider != null) {
            String picture = realmProvider.getRoad_worthy_sticker_image_url();
            boolean pictureExists = picture != null;
            if (pictureExists) {
                Glide.with(getContext())
                        .load(realmProvider.getRoad_worthy_sticker_image_url())
