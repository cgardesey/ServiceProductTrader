...
public class PersonalProviderAccountFragment1 extends MultiPickerWrapperSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View rootView = inflater.inflate(R.layout.fragment_personal_provider_account1, container, false);
    ...
    public void init() {
        ...
        if (realmProvider != null) {
            ...
            title.setSelection(((ArrayAdapter) title.getAdapter()).getPosition(realmProvider.getTitle()));
            firstName.setText(realmProvider.getFirst_name());
            lastName.setText(realmProvider.getLast_name());
            otherNames.setText(realmProvider.getOther_name());
            gender.setSelection(((ArrayAdapter) gender.getAdapter()).getPosition(realmProvider.getGender()));
        }
    }
