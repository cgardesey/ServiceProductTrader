...
import com.service.provision.adapter.ChooseRiderAccountAdapter;
...
public class ChooseRiderAccountMaterialDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.list_item_choose_rider_account,null);
        ...
        addaccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(
                        new Intent(getContext(), RiderProviderAccountActivity.class)
                                .putExtra("MODE", "ADD")
                );
                dismiss();
            }
         ...
         ChooseRiderAccountAdapter chooseRiderAccountAdapter = new ChooseRiderAccountAdapter((providers, position, holder) -> {
        ...
        recyclerView.setAdapter(chooseRiderAccountAdapter);
